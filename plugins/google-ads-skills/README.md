...
Google Ads y Analytics: Ads API, Data Manager API, Mobile Ads, IMA SDK, y las APIs Admin y Data de GA4.

**14 skills**, vendorizadas sin modificar desde
[`google/skills`](https://github.com/google/skills). Coste medido con `claude plugin details`:
**~2.213 tokens** en cada sesión mientras esté instalado.

Estas skills enseñan a **programar contra** las APIs. Para *consultar* tus cuentas, lo que quieres es el plugin `google-marketing-mcp`, que expone los servidores MCP de Ads, Analytics y Search Console.
